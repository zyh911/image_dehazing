...
DATASET_DIR = BASE_ROOT + '/data/dehaze/NTIRE' + INDOOR_OR_OUTDOOR_DIR + '/train_val_small_set'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR = BASE_ROOT + '/data/dehaze/NTIRE' + INDOOR_OR_OUTDOOR_DIR + '/train_val_small_set'
...
peek_images = [BASE_ROOT + '/data/dehaze/NTIRE' + INDOOR_OR_OUTDOOR_DIR + '/train_val_small_set/train/haze/0.png',  BASE_ROOT + '/data/dehaze/NTIRE' + INDOOR_OR_OUTDOOR_DIR + '/train_val_small_set/train/haze/100.png']
...
target_net = AOD_To_End_Deep1_Residual_Net()
