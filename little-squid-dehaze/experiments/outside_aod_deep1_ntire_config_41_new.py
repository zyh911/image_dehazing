...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/41_new'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/41_new'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/41_new/haze/0.png']
