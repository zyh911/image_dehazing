...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/45'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/45'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/45/3_haze/0.png']
