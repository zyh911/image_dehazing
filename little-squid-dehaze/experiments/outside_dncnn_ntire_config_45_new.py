...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/45_new'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/45_new'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/45_new/haze/0.png']
