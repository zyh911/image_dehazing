...
pic_num = '45'
test_snapshot_path = '/root/group-competition/zyh3/train_tasks/outside_aod_deep1_ntire_config_' + pic_num + '/models/snapshot_10_G_model'
...
TEST_OUT_FOLDER = '/root/group-competition/zyh3/outdoor_output/test1_aod_deep1'
