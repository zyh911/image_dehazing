...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/44'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/44'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/44/0_haze/0.png']
