...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/39'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/39'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/39/1_haze/0.png']
