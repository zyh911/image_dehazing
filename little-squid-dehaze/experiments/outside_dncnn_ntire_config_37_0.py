...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/37'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/37'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/37/2_haze/0.png']
