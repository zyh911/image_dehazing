...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/43'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/43'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/43/0_haze/0.png']
