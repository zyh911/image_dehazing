...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/mixed'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/mixed'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/mixed/0_haze/0.png']
...
train_dataset = Photo2PhotoData({
            ...
            'desc_file_path': os.path.join(DATASET_TXT_DIR_TRAIN, DATASET_ID, '16_train.txt'),
})
