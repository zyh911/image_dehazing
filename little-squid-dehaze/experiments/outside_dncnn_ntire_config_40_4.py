...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/40'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/40'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/40/2_haze/0.png']
