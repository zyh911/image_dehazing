...
DATASET_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/36'
DATASET_ID = 'aod_txt'
DATASET_TXT_DIR_TRAIN = BASE_ROOT + '/zyh3/ntire/outdoor/36'
...
peek_images = [BASE_ROOT + '/zyh3/ntire/outdoor/36/1_haze/0.png']
