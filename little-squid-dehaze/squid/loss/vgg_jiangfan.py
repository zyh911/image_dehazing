...
class VGG19FeatureTF(nn.Module):  # TensorFlow VGG19
    def __init__(self, vgg19_feature_model_path='', out_feature_level=4):
        ...
        self.features = nn.Sequential(*list(self.features.children())[:out_feature_level+1])
...
class VGGLoss1(nn.Module):
    ...
    def __init__(self, vgg19_feature_model_path='/root/group-competition/pretrain_model/vgg_tf.pth', out_feature_level=4):
