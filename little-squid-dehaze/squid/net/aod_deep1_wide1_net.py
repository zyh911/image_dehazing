...
class AOD_Deep1_Wide1_Net(nn.Module):
	def __init__(self):
		super(AOD_Deep1_Wide1_Net, self).__init__()
		self.conv1 = nn.Conv2d(3, 6, kernel_size=1, stride=1)
		self.relu1 = nn.ReLU(inplace=True)
		self.conv2 = nn.Conv2d(6, 6, kernel_size=3, stride=1, padding=1)
		self.relu2 = nn.ReLU(inplace=True)
		self.conv3 = nn.Conv2d(12, 6, kernel_size=3, stride=1, padding=1)
		self.relu3 = nn.ReLU(inplace=True)
		self.conv4 = nn.Conv2d(12, 6, kernel_size=5, stride=1, padding=2)
		self.relu4 = nn.ReLU(inplace=True)
		self.conv5 = nn.Conv2d(12, 6, kernel_size=5, stride=1, padding=2)
		self.relu5 = nn.ReLU(inplace=True)
		self.conv6 = nn.Conv2d(18, 6, kernel_size=7, stride=1, padding=3)
		self.relu6 = nn.ReLU(inplace=True)
		self.conv7 = nn.Conv2d(24, 6, kernel_size=7, stride=1, padding=3)
		self.relu7 = nn.ReLU(inplace=True)
		self.conv8 = nn.Conv2d(24, 6, kernel_size=5, stride=1, padding=2)
		self.relu8 = nn.ReLU(inplace=True)
		self.conv9 = nn.Conv2d(30, 6, kernel_size=5, stride=1, padding=2)
		self.relu9 = nn.ReLU(inplace=True)
		self.conv10 = nn.Conv2d(54, 3, kernel_size=3, stride=1, padding=1)
		self.relu10 = nn.ReLU()
