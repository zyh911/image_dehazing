...
class AOD_Deep_Net(nn.Module):
	def __init__(self):
		super(AOD_Deep_Net, self).__init__()
		...
		self.conv8 = nn.Conv2d(21, 3, kernel_size=3, stride=1, padding=1)
		self.relu8 = nn.ReLU()
	...
	def forward(self, x, target=None):
		...
		x7 = self.conv7(x7_0)
		x7 = self.relu7(x7)
		x8_0 = torch.cat((x1, x2, x3, x4, x5, x6, x7), dim=1)
		x8 = self.conv8(x8_0)
		x8 = self.relu8(x8)
		out = x8 * x - x8 + 1
		out = self.clip(out)
