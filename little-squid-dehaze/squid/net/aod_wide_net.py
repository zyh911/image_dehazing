...
class AOD_Wide_Net(nn.Module):
	def __init__(self):
		super(AOD_Wide_Net, self).__init__()
		...
		self.conv4 = nn.Conv2d(18, 18, kernel_size=7, stride=1, padding=3)
		self.relu4 = nn.ReLU(inplace=True)
		self.conv5 = nn.Conv2d(42, 3, kernel_size=3, stride=1, padding=1)
		self.relu5 = nn.ReLU()
