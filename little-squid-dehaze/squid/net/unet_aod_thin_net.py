...
class Unet_AOD_Thin_Net(nn.Module):
	def __init__(self):
		super(Unet_AOD_Thin_Net, self).__init__()
		...
		self.conv6 = nn.ConvTranspose2d(8, 8, kernel_size=3, stride=1, padding=1)
		self.bn6 = nn.BatchNorm2d(8)
		self.relu6 = nn.ReLU(inplace=True)
		self.conv7 = nn.ConvTranspose2d(16, 8, kernel_size=3, stride=1, padding=1)
		self.bn7 = nn.BatchNorm2d(8)
		self.relu7 = nn.ReLU(inplace=True)
		self.conv8 = nn.ConvTranspose2d(16, 8, kernel_size=3, stride=1, padding=1)
		self.bn8 = nn.BatchNorm2d(8)
		self.relu8 = nn.ReLU(inplace=True)
		self.conv9 = nn.ConvTranspose2d(16, 8, kernel_size=3, stride=1, padding=1)
		self.bn9 = nn.BatchNorm2d(8)
		self.relu9 = nn.ReLU(inplace=True)
		self.conv10 = nn.ConvTranspose2d(16, 3, kernel_size=3, stride=1, padding=1)
