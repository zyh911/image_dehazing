...
class AOD_Block_Residual_Net(nn.Module):
	def __init__(self):
		super(AOD_Block_Residual_Net, self).__init__()
		...
		self.relu5 = nn.ReLU()
		self.conv6 = nn.Conv2d(15, 3, kernel_size=1, stride=1)
		self.relu6 = nn.ReLU(inplace=True)
		self.conv7 = nn.Conv2d(3, 3, kernel_size=3, stride=1, padding=1)
		self.relu7 = nn.ReLU(inplace=True)
		self.conv8 = nn.Conv2d(6, 3, kernel_size=5, stride=1, padding=2)
		self.relu8 = nn.ReLU(inplace=True)
		self.conv9 = nn.Conv2d(6, 3, kernel_size=7, stride=1, padding=3)
		self.relu9 = nn.ReLU(inplace=True)
		self.conv10 = nn.Conv2d(12, 3, kernel_size=3, stride=1, padding=1)
		self.relu10 = nn.ReLU()
		self.conv11 = nn.Conv2d(15, 3, kernel_size=1, stride=1)
		self.relu11 = nn.ReLU(inplace=True)
		self.conv12 = nn.Conv2d(3, 3, kernel_size=3, stride=1, padding=1)
		self.relu12 = nn.ReLU(inplace=True)
		self.conv13 = nn.Conv2d(6, 3, kernel_size=5, stride=1, padding=2)
		self.relu13 = nn.ReLU(inplace=True)
		self.conv14 = nn.Conv2d(6, 3, kernel_size=7, stride=1, padding=3)
		self.relu14 = nn.ReLU(inplace=True)
		self.conv15 = nn.Conv2d(12, 3, kernel_size=3, stride=1, padding=1)
		self.relu15 = nn.ReLU()
	...
	def forward(self, x, target=None):
		...
		x6_0 = torch.cat((x1, x2, x3, x4, x5), dim=1)
		x6 = self.conv6(x6_0)
		x6 = self.relu6(x6)
		x7_0 = x6
		x7 = self.conv7(x7_0)
		x7 = self.relu7(x7)
		x8_0 = torch.cat((x6, x7), dim=1)
		x8 = self.conv8(x8_0)
		x8 = self.relu8(x8)
		x9_0 = torch.cat((x7, x8), dim=1)
		x9 = self.conv9(x9_0)
		x9 = self.relu9(x9)
		x10_0 = torch.cat((x6, x7, x8, x9), dim=1)
		x10 = self.conv10(x10_0)
		x10 = self.relu10(x10)

		x11_0 = torch.cat((x6, x7, x8, x9, x10), dim=1)
		x11 = self.conv11(x11_0)
		x11 = self.relu11(x11)
		x12_0 = x11
		x12 = self.conv12(x12_0)
		x12 = self.relu12(x12)
		x13_0 = torch.cat((x11, x12), dim=1)
		x13 = self.conv13(x13_0)
		x13 = self.relu13(x13)
		x14_0 = torch.cat((x12, x13), dim=1)
		x14 = self.conv14(x14_0)
		x14 = self.relu14(x14)
		x15_0 = torch.cat((x11, x12, x13, x14), dim=1)
