...
class AOD_Deep3_Net(nn.Module):
	def __init__(self):
		super(AOD_Deep3_Net, self).__init__()
		...
		self.conv8 = nn.Conv2d(15, 3, kernel_size=7, stride=1, padding=3)
		self.relu8 = nn.ReLU(inplace=True)
		self.conv9 = nn.Conv2d(15, 3, kernel_size=5, stride=1, padding=2)
		self.relu9 = nn.ReLU(inplace=True)
		self.conv10 = nn.Conv2d(15, 3, kernel_size=5, stride=1, padding=2)
		self.relu10 = nn.ReLU(inplace=True)
		self.conv11 = nn.Conv2d(18, 3, kernel_size=5, stride=1, padding=2)
		self.relu11 = nn.ReLU(inplace=True)
		self.conv12 = nn.Conv2d(18, 3, kernel_size=3, stride=1, padding=1)
		self.relu12 = nn.ReLU(inplace=True)
		self.conv13 = nn.Conv2d(18, 3, kernel_size=3, stride=1, padding=1)
		self.relu13 = nn.ReLU(inplace=True)
		self.conv14 = nn.Conv2d(39, 3, kernel_size=3, stride=1, padding=1)
		self.relu14 = nn.ReLU()
	...
	def forward(self, x, target=None):
		...
		x7 = self.conv7(x7_0)
		x7 = self.relu7(x7)
		x8_0 = torch.cat((x3, x4, x5, x6, x7), dim=1)
		x8 = self.conv8(x8_0)
		x8 = self.relu8(x8)
		...
		x12 = self.relu12(x12)
		x13_0 = torch.cat((x7, x8, x9, x10, x11, x12), dim=1)
		x13 = self.conv13(x13_0)
		x13 = self.relu13(x13)
		x14_0 = torch.cat((x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13), dim=1)
