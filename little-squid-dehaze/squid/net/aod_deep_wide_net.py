...
class AOD_Deep_Wide_Net(nn.Module):
	def __init__(self):
		super(AOD_Deep_Wide_Net, self).__init__()
		...
		self.conv4 = nn.Conv2d(32, 16, kernel_size=5, stride=1, padding=2)
		self.relu4 = nn.ReLU(inplace=True)
		self.conv5 = nn.Conv2d(32, 16, kernel_size=5, stride=1, padding=2)
		self.relu5 = nn.ReLU(inplace=True)
		self.conv6 = nn.Conv2d(48, 16, kernel_size=7, stride=1, padding=3)
		self.relu6 = nn.ReLU(inplace=True)
		self.conv7 = nn.Conv2d(64, 16, kernel_size=7, stride=1, padding=3)
		self.relu7 = nn.ReLU(inplace=True)
		self.conv8 = nn.Conv2d(64, 16, kernel_size=5, stride=1, padding=2)
		self.relu8 = nn.ReLU(inplace=True)
		self.conv9 = nn.Conv2d(80, 16, kernel_size=5, stride=1, padding=2)
		self.relu9 = nn.ReLU(inplace=True)
		self.conv10 = nn.Conv2d(16*9, 3, kernel_size=3, stride=1, padding=1)
		self.relu10 = nn.ReLU()
